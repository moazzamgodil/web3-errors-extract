...
const _getErrorMessage = (err, web3, state) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (err === null || err === void 0 ? void 0 : err.message) {
        ...
        if (!ret &&
            (((_c = err.message) === null || _c === void 0 ? void 0 : _c.includes("execution reverted")) && (((_d = err.message) === null || _d === void 0 ? void 0 : _d.indexOf("{")) !== -1 || ((err === null || err === void 0 ? void 0 : err.data) != null && (err === null || err === void 0 ? void 0 : err.data) != undefined))) ||
            (((_e = err.message) === null || _e === void 0 ? void 0 : _e.includes("Internal JSON-RPC error")) && ((err === null || err === void 0 ? void 0 : err.data) != null && (err === null || err === void 0 ? void 0 : err.data) != undefined))) {
            ret = yield (0, executionReverted_1.default)(err, state, web3);
        }
        if (!ret
            && ((_f = err.message) === null || _f === void 0 ? void 0 : _f.includes("execution reverted:"))) {
